...
namespace simpleCNN {
    ...
    template<typename T         = float_t,
            typename Activation = activation::ReLU<T>>
    ...
    public:
        ...
        * @param horizontal_stride  [in] specify the horizontal interval at which to apply the filters to the input
        * @param vertical_stride    [in] specify the vertical interval at which to apply the filters to the input
        ...
        **/
        ...
        data_t out_shape() const override
        {
            return data_t({params_.out});
        }
    ...
    private:
        ...
        /*
         * Default tensor_t has 3 dimensions where tensor_t(channel, row, column)
...
//                kernel_bwd_.reset(new Conv2dGradOp(ctx));
        ...
        /*
         * Forward and backward ops (only this object executes this kernel)
         */
