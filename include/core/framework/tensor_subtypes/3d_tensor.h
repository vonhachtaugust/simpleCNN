...
namespace simpleCNN {
    ...
    enum class component_t {
        UNSPECIFIED, IN_DATA, OUT_DATA, WEIGHT, BIAS, AUX
    };
    ...
    */
    ...
    public:
        ...
        explicit Tensor_3(component_t component)
                :Base()
        {
            component_ = component;
        }

        explicit Tensor_3(const std::initializer_list<size_t>& shape, component_t component)
                :Base(shape)
        {
            component_ = component;
        }
